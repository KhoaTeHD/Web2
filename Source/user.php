  ...
  <div id="main-user" >
    ...
    <div id="main-content">
        <div id="tab-bar-user">
            ...
            <p class="content-tab-bar-user" style="margin-bottom: 12px;color:#fff;width: 100%;height: 50px;text-align: center;line-height: 50px;"><a href="user.php">Thông tin tài khoản</a></p>
